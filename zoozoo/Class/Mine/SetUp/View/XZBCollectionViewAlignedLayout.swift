//
//  XZBCollectionViewAlignedLayout.swift
//  xiaohongshu
//
//  Created by 🍎上的豌豆 on 2018/12/4.
...
public class XZBCollectionViewAlignedLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: XZBCollectionViewAlignedLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: XZBCollectionViewAlignedLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: XZBCollectionViewAlignedLayout) {
    ...
    private func alignToFollowingItem(collectionViewLayout: XZBCollectionViewAlignedLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: XZBCollectionViewAlignedLayout) {
    ...
    func alignVertically(collectionViewLayout: XZBCollectionViewAlignedLayout) {
