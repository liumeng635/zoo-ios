...
class RToolBar: UIView {
    ...
    open var toolbar: UIToolbar {
        ...
        if !hideCancelButton {
            ...
            toolBarL.appendButton(buttonItem: toolBarL.buttonItem(title: "取消", systemItem: .cancel, selector: #selector(self.cancelAction)))
        ...
        let toolBarTitleItem = toolBarL.titleItem(text: "", font: UIFont(name: "PingFang-SC-Medium", size: 15.0)!, color: UIColor.black)
        
        self.toolBarTitleItem = toolBarTitleItem as? ToolBarTitleItem
        toolBarL.appendButton(buttonItem: toolBarTitleItem)
        toolBarL.appendButton(buttonItem: toolBarL.flexibleSpace)

        toolBarL.appendRightButton(buttonItem: toolBarL.buttonItem(title: "确定", systemItem: .done, selector: #selector(self.doneAction)))
...
class ToolBar: UIToolbar {
    ...
    func buttonItem(title: String ,systemItem: UIBarButtonItem.SystemItem, selector: Selector?) -> UIBarButtonItem{
    ...
    func appendButton(buttonItem: UIBarButtonItem) {
        ...
        buttonItem.setTitleTextAttributes([
            NSAttributedString.Key.font: UIFont(name: "PingFang-SC-Medium", size: 15.0)!,
            NSAttributedString.Key.foregroundColor:  ColorBlackTitle],
                                          for: .normal)
        
        items!.append(buttonItem)
    }
    func appendRightButton(buttonItem: UIBarButtonItem) {
        if items == nil {
            items = [UIBarButtonItem]()
        }
        buttonItem.setTitleTextAttributes([
            NSAttributedString.Key.font: UIFont(name: "PingFang-SC-Medium", size: 15.0)!,
            NSAttributedString.Key.foregroundColor:  ColorCancleColor],
                                          for: .normal)
