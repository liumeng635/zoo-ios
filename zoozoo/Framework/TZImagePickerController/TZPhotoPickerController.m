...
- (void)viewDidLoad {
    ...
    [btn addTarget:tzImagePickerVc action:@selector(cancelButtonClick) forControlEvents:UIControlEventTouchUpInside];
...
- (void)configBottomToolBar {
    ...
    [_previewButton setTitleColor:[UIColor colorWithRed:51 / 255.0 green:51 / 255.0 blue:51 / 255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setTitleColor:[UIColor colorWithRed:51 / 255.0 green:51 / 255.0 blue:51 / 255.0 alpha:1.0] forState:UIControlStateSelected];
    ...
    _doneButton.backgroundColor = [UIColor colorWithRed:164/255.0 green:53/255.0 blue:252/255.0 alpha:1.0];
...
//     [self gradientLayerButton:_doneButton];
...
- (void)gradientLayerButton:(UIButton *)button{
    ...
    UIColor *startColor = [UIColor colorWithRed:104/255.0 green:95/255.0 blue:213/255.0 alpha:1.0];
    UIColor *endColor = [UIColor colorWithRed:164/255.0 green:53/255.0 blue:252/255.0 alpha:1.0];
...
//    [_doneButton sizeToFit];
    _doneButton.frame = CGRectMake(self.view.tz_width - 60 - 15, 10, 60, 30);
